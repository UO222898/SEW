...
class Pais {
    ...
    cargarPrediccionTiempo(){
        ...
        this.idioma = "&lang=es";
        this.url = "http://api.openweathermap.org/data/2.5/forecast?lat="+this.coordLatitud+"&lon="+this.coordLongitud+ this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey;
